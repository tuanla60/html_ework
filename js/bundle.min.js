...
function showMenu(){$("html");var e=document.getElementById("body_area"),a=document.getElementById("btn_show_menu"),n=document.getElementById("showNavSideMenu");return-1===e.className.indexOf("menu-open")?e.className+=" menu-open":e.className=e.className.replace(" menu-open",""),-1===a.className.indexOf("active")?a.className+=" active":a.className=a.className.replace(" active",""),-1===n.className.indexOf("show")?n.className+=" show":n.className=n.className.replace(" show",""),!1}$(document).ready(function(){$(".fragment .btn-off").on("click",function(e){e.preventDefault(),$(".fragment").hide()}),$(".btn-toggle").on("click",function(e){$(this).next("ul").toggleClass("active"),$(this).toggleClass("active"),e.stopPropagation(),e.preventDefault()})});